...
export function SmartSearch() {
 ...
 return (
 <div className="w-full border-2 border-foreground bg-background shadow-[8px_8px_0_0_#2563EB]">
 ...
 />
 <span className="hidden shrink-0 items-center gap-1.5 bg-primary/10 px-3 py-1 text-xs font-medium text-primary sm:flex">
 ...
 key={role.title}
 href="/jobs"
 className="group flex items-center gap-3 px-3 py-3 transition-colors hover:bg-primary/5"
 >
 ...
 <span className={`shrink-0 px-2.5 py-1 text-xs font-medium ${matchStyles[role.match]}`}>
 {role.match}
 </span>
