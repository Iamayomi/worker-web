...
export default function LandingPage() {
 ...
 <div className="mx-auto mt-8 w-full max-w-6xl overflow-hidden border border-border bg-card shadow-lg">
 ...
 <Link
 href={searchHref}
 className="inline-flex h-12 w-full items-center justify-center gap-2 bg-primary px-8 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90 md:h-full"
 >
 ...
 <Link
 href="/register"
 className="inline-flex h-11 items-center justify-center bg-primary px-6 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90"
 >
  Get started
  </Link>
  </div>
 ...
 className="absolute bottom-5 right-5 z-10 inline-flex h-10 items-center justify-center gap-2 border border-white/40 bg-black/30 px-4 text-sm font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/10"
 >
 ...
 className="group flex items-start gap-4 border border-border bg-card p-5 text-left transition-all hover:border-primary hover:shadow-md"
 >
 <span className="flex h-11 w-11 shrink-0 items-center justify-center bg-muted text-primary">
 ...
 <Link
 href="/register"
 className="mt-8 inline-flex h-11 items-center justify-center bg-primary px-6 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90"
 >
 Post a job
 </Link>
 </div>
 ...
 <div
 key={card.step}
 className="overflow-hidden border border-border bg-card transition-shadow hover:shadow-lg"
 >
 ...
 />
 <span className="absolute left-4 top-4 inline-flex h-8 w-8 items-center justify-center bg-primary text-sm font-bold text-primary-foreground">
 {card.step}
 </span>
 </div>
 <div className="p-6">
 ...
 className="group flex flex-col border border-border bg-card p-6 transition-shadow hover:shadow-lg"
 >
 ...
 {subscribed ? (
 <div className="mx-auto mt-8 flex max-w-md items-center justify-center gap-2 border border-border bg-card px-6 py-4 text-base font-medium">
 ...
 className="h-12 flex-1 border border-border bg-background px-4 text-base focus:outline-none focus:ring-2 focus:ring-ring"
 />
 <button
 type="submit"
 className="inline-flex h-12 items-center justify-center bg-primary px-6 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90"
 >
 Get job alerts
 </button>
 </form>
 ...
 <Link href="/register" className="inline-flex h-11 items-center justify-center bg-primary px-6 text-base font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90">
 Create a free account
 </Link>
 <Link href="/jobs" className="inline-flex h-11 items-center justify-center border border-border bg-background px-6 text-base font-medium transition-colors hover:bg-muted">
 Browse jobs
 </Link>
 </div>
 </div>
 ...
 {showNotification && (
 <div className="fixed bottom-4 right-4 z-50 flex max-w-sm items-start gap-3 border border-border bg-card p-4 shadow-lg sm:bottom-6 sm:right-6">
 ...
 className="ml-1 flex h-6 w-6 shrink-0 items-center justify-center text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
 >
