...
export default function TalentMarketReportPage() {
 ...
 <Link
 href="/jobs"
 className="inline-flex h-11 items-center justify-center border border-border bg-background px-6 text-base font-medium transition-colors hover:bg-muted"
 >
 Browse jobs
 </Link>
 </div>
 ...
 <Link
 href="/register"
 className="inline-flex h-11 items-center justify-center gap-2 bg-primary px-6 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90"
 >
