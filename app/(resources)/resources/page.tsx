...
function PostCard({ post }: { post: Post }) {
 ...
 >
 {post.coverImage ? (
 <div className="mb-4 h-36 w-full overflow-hidden bg-muted">
...
function ResourcesContent() {
 ...
 className="mb-8 flex flex-col gap-3 border border-primary/20 bg-primary/5 p-6 transition-colors hover:border-primary/40 sm:flex-row sm:items-center sm:justify-between"
 >
