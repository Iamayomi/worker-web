...
return (
 ...
 <span
 key={skill}
 className="inline-flex items-center gap-1 bg-secondary px-2 py-1 text-sm"
 >
 {skill}
 <button
 type="button"
 ...
 className=" p-0.5 text-muted-foreground transition-colors hover:bg-foreground/10 hover:text-foreground"
 >
 <X className="h-3 w-3" />
 </button>
 </span>
...
function RegisterSidePanel({ mode }: { mode: RegisterMode }) {
 ...
 return (
  ...
  <img
  src={
  isTalent ? "/images/talent-signup.jpg" : "/images/client-signup.jpg"
  }
 ...
 <div className=" border border-white/20 bg-black/30 p-4 backdrop-blur-sm">
...
function RegisterModeTabs({
 ...
 return (
 <div className="mb-8 flex items-center gap-1 border border-border bg-muted/40 p-1">
 {tabs.map((tab) => (
 <button
 key={tab.value}
 type="button"
...
export default function RegisterPage() {
 ...
 return (
  <AuthGuard>
  <div className="grid w-full md:min-h-[calc(100vh-4rem)] md:grid-cols-2">
  <RegisterSidePanel mode={mode} />
  <div className="flex justify-center p-6 sm:p-8 md:items-center">
