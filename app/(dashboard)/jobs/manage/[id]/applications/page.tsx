...
export default function JobApplicationsPage() {
 ...
 <div key={i} className="h-24 animate-pulse border border-border/15 bg-muted" />
 ))}
 </div>
 ...
 <div
 key={application.id}
 className="group border border-border/15 p-4 transition-colors hover:border-border/30"
 >
