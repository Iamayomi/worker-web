...
function AdminProfileView({ user }: { user: UserData }) {
 ...
 return (
 <>
 <div className=" border border-border/15 bg-card p-6 shadow-sm sm:p-8">
...
function ClientProfileView() {
 ...
 {isVerified && (
 <span className="inline-flex items-center gap-1.5 bg-blue-500/10 px-3 py-1 text-xs font-medium text-blue-600">
