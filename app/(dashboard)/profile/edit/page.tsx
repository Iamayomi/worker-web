...
function TalentProfileEdit() {
 ...
 <label className="inline-flex h-10 cursor-pointer items-center gap-2 border border-border px-4 text-sm font-medium transition-colors hover:border-primary/40 hover:text-primary">
 ...
 {form.resumeUrl ? (
 <div className="flex h-10 items-center gap-2 border border-border/15 bg-muted/30 px-3 text-sm">
