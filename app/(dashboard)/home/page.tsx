...
export default function TalentHomePage() {
 ...
 <section className=" bg-neutral-950 p-6 shadow-xl shadow-neutral-950/20 sm:p-8">
 ...
 <Link
 href="/jobs"
 className="inline-flex items-center gap-1.5 border border-neutral-200 bg-white px-3 py-2 text-sm font-medium text-neutral-900 transition-colors hover:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
 >
 View all jobs
