...
function HireRatingCard({ applicationId }: { applicationId: string }) {
 ...
 className=" p-1 text-muted-foreground hover:bg-secondary"
 >
 <Star
 className={cn(
 "h-6 w-6",
...
export default function ApplicationDetailPage() {
 ...
 <div className="mt-2 h-4 w-2/3 animate-pulse bg-muted" />
 </div>
 ) : (
 <>
 <div className=" border border-border/15 p-5">
 ...
 <div className="flex flex-wrap items-center justify-between gap-3 border border-border/10 px-3 py-2">
