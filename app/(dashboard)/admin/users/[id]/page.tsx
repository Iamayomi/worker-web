...
export default function AdminUserDetailPage() {
 ...
 {isAdmin && (
 <div className="flex flex-wrap items-center gap-x-8 gap-y-3 border border-border/15 px-5 py-3">
 <Link
 ...
 {isSuperAdmin && (
 <div className="flex items-center gap-2 border border-border/15 px-4 py-3 text-sm text-muted-foreground">
