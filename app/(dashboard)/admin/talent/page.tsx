...
export default function AdminTalentPage() {
 ...
 Individuals looking for work on Worker.
 </p>
 </div>
 <ExportCsvButton
 filename={`talents-${new Date().toISOString().slice(0, 10)}.csv`}
 ...
 <AdminSubNav active="talent" />

 <AccountTotals accountType={AccountType.TALENT} />

 <UsersTable
 fixedAccountType={AccountType.TALENT}
