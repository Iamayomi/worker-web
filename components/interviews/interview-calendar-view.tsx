...
function MonthCalendar({
  ...
  return (
    <div className="rounded-lg border border-border/15 p-4">
      ...
      <div className="grid grid-cols-7 gap-px overflow-hidden rounded-md border border-border/15 bg-border/60 text-center">
              ...
              <div className="mt-1 space-y-1">
                {cell.interviews.slice(0, 3).map((interview) => (
                  <Link
                    ...
                    className="block truncate rounded bg-muted px-1.5 py-0.5 text-[11px] leading-4 text-foreground hover:bg-primary/10 hover:text-primary"
                  >
                    {formatInterviewTime(
...
export function CalendarItem({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border/15 p-4">
