    ...
    <div className="space-y-5">
      ...
      {hasApplication && applicants.length > 0 && (
        <div className="space-y-2">
          ...
          <div className="max-h-56 space-y-1 overflow-y-auto rounded-lg border border-border/15 p-2">
            {applicants.map((applicant) => (
              <label
                key={applicant.id}
                className="flex cursor-pointer items-center gap-3 rounded-md px-2 py-1.5 transition-colors hover:bg-secondary"
              >
                <Checkbox
