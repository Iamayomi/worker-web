...
export function PostJobPage() {
 ...
 <div className="mx-auto flex h-12 w-12 items-center justify-center bg-amber-500/10 text-amber-500">
 ...
 <div className=" border border-border/15 p-8 text-center">
 <div className="mx-auto flex h-12 w-12 items-center justify-center bg-green-600/10 text-green-600">
