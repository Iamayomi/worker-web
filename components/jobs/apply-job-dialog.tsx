...
export function ApplyJobDialog({ job, open, onOpenChange }: ApplyJobDialogProps) {
 ...
 {cvValue ? (
 <div className="flex items-center gap-3 border border-border/15 bg-muted/30 p-3">
 ...
 className="flex w-full items-center justify-center gap-2 border border-dashed border-border p-6 text-sm text-muted-foreground transition-colors hover:border-primary hover:text-foreground"
 >
 {uploadCv.isPending ? (
 ...
 <div className="space-y-4 py-2">
 <div className="space-y-1 border border-border/15 bg-muted/30 p-4 text-sm">
