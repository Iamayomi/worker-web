...
function ConversationRow({
 ...
 {item.unreadCount > 0 && (
 <span className="inline-flex h-5 min-w-5 shrink-0 items-center justify-center bg-primary px-1.5 text-xs font-semibold text-primary-foreground">
 {item.unreadCount}
 </span>
 )}
 </span>
...
export function FloatingChat() {
 ...
 {open && (
 <div
 className="fixed z-50 flex h-[560px] max-h-[calc(100dvh-7.5rem)] w-[400px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-lg border border-border/15 bg-background shadow-2xl"
 style={
 ...
 className=" p-1 text-muted-foreground transition-colors hover:bg-secondary/60 hover:text-foreground"
 ...
 className=" p-2 text-muted-foreground transition-colors hover:bg-secondary/60 hover:text-foreground"
 title="New message"
 >
