...
export function PageEditorSidebar({ page }: { page?: Page | null }) {
 ...
 <div className="space-y-4 border border-border/15 bg-card p-5">
 <div className="flex items-center gap-2">
 <div className="flex size-8 items-center justify-center bg-secondary text-muted-foreground">
 ...
 <code className="truncate bg-muted px-1.5 py-1 text-xs">
 /{page.slug}
 </code>
 <ViewLiveButton
 href={`/${page.slug}`}
 ...
 {page.status !== PostStatus.PUBLISHED && (
 <p className="flex items-start gap-1.5 bg-yellow-500/10 px-2.5 py-2 text-xs text-yellow-600">
 ...
 <div className=" border border-border/15 bg-card p-4 text-xs text-muted-foreground">
