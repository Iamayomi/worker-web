...
export function RichTextEditor({
  ...
  if (!editor) {
    return (
      <div className="min-h-[220px] rounded-md border border-border/15 bg-muted/30 p-4">
  ...
  return (
    <div
      className={cn(
        "overflow-hidden rounded-md border border-border/15 focus-within:border-primary/60 focus-within:ring-2 focus-within:ring-primary/20",
        disabled && "opacity-60"
      )}
    >
