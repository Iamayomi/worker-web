...
function RecipientPicker({
 ...
 <span
 key={person.userId}
 className="inline-flex items-center gap-1.5 border border-border/20 bg-secondary/60 py-1 pl-2 pr-1 text-xs"
 >
 {person.name}
 <button
 type="button"
 onClick={() => onToggle(person)}
 className=" p-0.5 text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground"
 ...
 <div className="max-h-40 overflow-y-auto border border-border/15">
 {isFetching ? (
...
export function SendNotificationForm() {
 ...
 return (
 <div className="space-y-4 border border-border/15 p-5">
 <div>
