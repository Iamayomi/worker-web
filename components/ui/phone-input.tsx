...
export function PhoneInput({
 ...
 return (
 <div className="flex h-8 w-full min-w-0 items-center border border-input bg-transparent px-2.5 transition-colors focus-within:border-foreground dark:bg-input/30">
