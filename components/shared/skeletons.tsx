...
export function StatCardsSkeleton({ count = 6 }: { count?: number }) {
 ...
 <div key={i} className=" border border-border/15 p-5">
...
export function TalentHomeSkeleton() {
 ...
 <div className=" border border-border/15 bg-gradient-to-br from-primary/10 via-transparent to-transparent p-8 sm:p-12">
