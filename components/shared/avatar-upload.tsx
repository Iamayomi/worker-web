...
export function AvatarUpload({
 ...
 <span className="absolute inset-x-0 bottom-0 flex items-center justify-center bg-black/50 py-0.5 text-white opacity-0 transition-opacity group-hover:opacity-100">
